...
const StateEmpty = () => {
  return (
    <div class="w-full desktop:gap-30 gap-4 desktop:px-20 desktop:my-20 tablet:px-10 px-16 my-10 grid desktop:grid-cols-4 tablet:grid-cols-3 grid-cols-1 relative">
      {/* States skeletons */}
      <div class="flex flex-col justify-center gap-8 desktop:p-0 tablet:p-0 px-8 col-span-1">
        <div class="flex flex-row gap-4">
          <img
            src={humid}
            class="desktop:w-[72px] desktop:h-[72px] w-12 h-12"
            alt="humid"
          ></img>
          <div class="w-full">
      ...
      <div class="flex justify-center items-center desktop:col-span-2 col-span-1">
        <div class="flex justify-center items-center desktop:w-[412px] desktop:h-[320px] tablet:w-[240px] tablet:h-[184.59px] w-[200px] h-[153.82px] rounded-[24px]  bg-gray-300 ">
          <svg
      ...
      <div class="flex flex-col justify-center desltop:gap-8 tablet:gap-2.5 gap-4 relative desktop:p-0 tablet:px-4 col-span-1">
        <div class="grid grid-cols-2 desktop:gap-4 gap-2">
          <div class="desktop:h-[32px] tablet:h-[20px] h-[16px] flex items-center">
            <div class="desktop:h-6 tablet:h-4 h-3.5 bg-gray-300 rounded-full w-full"></div>
          </div>
          <div class="desktop:h-[32px] tablet:h-[20px] h-[16px] flex items-center">
            <div class="desktop:h-5 tablet:h-3.5 h-2.5 bg-gray-200 rounded-full w-full"></div>
          </div>
        </div>
        <div class="h-full w-full">
          <div role="status" class="space-y-2.5">
            <div class="flex items-center space-x-2 w-full">
              <div class="desktop:h-4 h-3 bg-gray-200 rounded-full w-32"></div>
              <div class="desktop:h-4 h-3 bg-gray-300 rounded-full w-24"></div>
            ...
            <div class="flex items-center w-full space-x-2">
              <div class="desktop:h-4 h-3 bg-gray-300 rounded-full w-full"></div>
              <div class="desktop:h-4 h-3 bg-gray-200 rounded-full w-80"></div>
              <div class="desktop:h-4 h-3 bg-gray-300 rounded-full w-full"></div>
            </div>
            <div class="flex items-center w-full space-x-2">
              <div class="desktop:h-4 h-3 bg-gray-200 rounded-full w-full"></div>
