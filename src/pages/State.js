...
function State() {
  return (
    <div class="mt-[60px] justify-center tablet:pt-5 tablet:mt-0 ">
      <div class="justify-center">
        ...
        <div class=" w-full h-[307.64px] flex flex-row justify-center mt-20 mb-20 tablet:h-[264.59px] tablet:mt-0 tablet:mb-10">
          <div class="flex justify-center w-[1560px] phone:flex-wrap">
            <div class="pt-10 pb-10 flex flex-col justify-center  tablet:pr-10">
            ...
            <div class="phone:flex justify-center">
              <img
                src={plant2}
            ...
            <div class=" tablet:mt-[17.29px] tablet:pl-5">
              ...
              <Typography class="mt-8 w-[219px] text-[20px] tablet:text-[14px] tablet:w-[151px] tablet:mt-5 phone:w-[200px] phone:h-[84px] ">
